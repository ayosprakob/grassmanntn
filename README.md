...
```
Of course, you need to identify the index separation first. Hermitian conjugate is only well-defined when the indices are separated into two groups, corresponding to the two matrix indices.
